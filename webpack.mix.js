...
/*
mix.js('assets/js/privat/privat.js', 'c:\\OSPanel\\domains\\unix\\js\\');
mix.sass('assets/sass/privat.scss', '/css').options({processCssUrls: false});
*/
...
//mix.js('assets/js/admin/fonts/app.js', 'c:\\OSPanel\\domains\\unix\\js\\vue\\admin\\fonts\\');

//mix.browserSync('http://unix/');
